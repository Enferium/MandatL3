...
if ($_SESSION['droit'] == 3) {
		  	...
		  	<button class="btn btn-default dropdown-toggle" type="button" id="dropdownMenu1" data-toggle="dropdown" aria-expanded="true">
		    	...
		    	<span class="caret"></span>
		  		...
		  		<ul class="dropdown-menu" role="menu" aria-labelledby="dropdownMenu1">
		    		<li role="presentation"><a role="menuitem" tabindex="-1" href="?action=etudiant">Etudiant</a></li>
		   		 	<li role="presentation"><a role="menuitem" tabindex="-1" href="?action=pays">Pays</a></li>
		    		<li role="presentation"><a role="menuitem" tabindex="-1" href="?action=droit">Droits</a></li>
		    		<li role="presentation"><a role="menuitem" tabindex="-1" href="?action=diplome">Diplome</a></li>
		  		</ul>
			</div>
		</div>
	</div>
	...
	if (isset($_GET["action"]) && $_GET["action"] =="pays" ) {
		?>
		<div class="container">
        	<div class="row">
				<div class="btn-group" role="group" aria-label="...">
	...
	if (isset($_GET["action"]) && $_GET["action"] =="droit" ) {
		?>
		<div class="container">
        	<div class="row">
				<div class="btn-group" role="group" aria-label="...">
	...
	if (isset($_GET["action"]) && $_GET["action"] =="diplome" ) {
		?>
		<div class="container">
        	<div class="row">
				<div class="btn-group" role="group" aria-label="...">
